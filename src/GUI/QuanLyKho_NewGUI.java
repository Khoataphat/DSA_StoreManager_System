...
public class QuanLyKho_NewGUI extends JFrame {

    private DrawerController drawer;

    public QuanLyKho_NewGUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyKho_NewGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyKho_NewGUI().setVisible(true);
            }
        });
    }
