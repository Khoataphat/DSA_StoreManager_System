...
/*
    ...
    public void loadDtatatoBestSeller(){
        ...
        //Duyệt qua danh sách và loại bỏ sản phẩm nào có số lượng bằng 0
        for (AmountSold amountSold : list) {
            if (Run.ProductTree.search(list.get(0).getMaMay()).get(0).getSoLuong() == 0) {
            list.remove(amountSold);
           }
        }
        //Đặt mã máy của top 3 sản phẩm bán chạy nhất vào các trường văn bản (txtTop1, txtTop2, txtTop3)
