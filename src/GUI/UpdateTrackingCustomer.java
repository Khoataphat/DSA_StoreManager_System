...
public class UpdateTrackingCustomer extends javax.swing.JDialog {
    private LichSuMuaCustomer owner;
    private Account currentAcc;
    public UpdateTrackingCustomer(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal, Account currentAcc){
        super(owner, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.owner = (LichSuMuaCustomer) parent;
    ...
    private void initComponents() {
        ...
        cmbTrangThaiDon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Đã nhận hàng", "Hủy Đơn" }));
    ...
    private void btnupdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnupdateMouseClicked
        try {
            ...
            Logger.getLogger(UpdateTrackingCustomer.class.getName()).log(Level.SEVERE, null, ex);
